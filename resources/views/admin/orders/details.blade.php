                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr>
                                            ...
                                            <td class="fw-bold text-end">23/12/2023</td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">
                                                <div class="d-flex align-items-center">
                                                    <i class="ki-duotone ki-wallet fs-2 me-2"><span
                                                            ...
                                                            class="path3"></span><span class="path4"></span></i> Payment
                                                    Method
                                                </div>
                                            </td>
                                            ...
                                            <td class="fw-bold text-end">
                                                <div class="d-flex align-items-center justify-content-end">
                                                    ...
                                                    <div class="symbol symbol-circle symbol-25px overflow-hidden me-3">
                                                        <a
                                                            href="/metronic8/demo1/../demo1/apps/ecommerce/customers/details.html">
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr>
                                            ...
                                            <td class="fw-bold text-end"><a
                                                    href="/metronic8/demo1/../demo1/apps/invoices/view/invoice-3.html"
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/edit-product.html"
                                                                ...
                                                                <span class="symbol-label"
                                                                    style="background-image:url(/metronic8/demo1/assets/media//stock/ecommerce/1.png);"></span>
                                                            </a>
                                                            <!--end::Thumbnail-->
                                                            ...
                                                            <div class="ms-5">
                                                                <a href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/edit-product.html"
                                                                    ...
                                                                    1</a>
                                                                <div class="fs-7 text-muted">Delivery Date: 23/12/2023
                                                                </div>
                                                            </div>
                                                            <!--end::Title-->
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/edit-product.html"
                                                                class="symbol symbol-50px">
                                                                <span class="symbol-label"
                                                                    style="background-image:url(/metronic8/demo1/assets/media//stock/ecommerce/100.png);"></span>
                                                            </a>
                                                            <!--end::Thumbnail-->
