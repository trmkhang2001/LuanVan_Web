...
<div class="container-fluid bg-white">
    <div class="container">
        <div class="row pt-4">
            <div class="col-6">
                <p class="fs-5 fw-bold text-uppercase">Công Ty TNHH Thương Mại MK Computer </p>
                <p class="fw-bold">180 Cao Lỗ, Phường 4, Quận 8, Tp. Hồ Chí Minh</p>
                <p>Phone: 0867411902</p>
                <p>Email: trmkhang2001@gmail.com</p>
            </div>
        ...
        <div class="row text-center">
            <p class="fw-bold font-dark">© 2023, MK Computer.</p>
        </div>
    </div>
</div>
